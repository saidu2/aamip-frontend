      ...
      >
          ...
          <div style={{
            ...
            <span style={{ fontSize: 12, color: scraperStatus.is_current ? 'var(--success)' : 'var(--warning)' }}>
              {scraperStatus.is_current
                ...
                : '⚠ Last update: ' + (scraperStatus.last_price_date || 'never') + ' — click Auto-Fetch NGX or upload prices CSV'}
            </span>
            <span style={{ fontSize: 11, color: 'var(--text-muted)' }}>{scraperStatus.total_price_records} total records</span>
          </div>
        )}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 24 }}>
          ...
          <Card
            ...
            subtitle="30-day closing prices from database — click a stock below to view"
          >
        ...
        {/* Gainers / Losers */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 24 }}>
          <Card title="Top Gainers" subtitle="Click to view price chart" goldAccent>
          ...
          <Card title="Top Losers" subtitle="Click to view price chart">
        ...
        {/* Macro indicators */}
        <Card title="Macroeconomic Indicators" subtitle="CBN / NBS — upload CSV to update">
          {macro.length === 0 ? (
        ...
        <div style={{ marginTop: 16, padding: '12px 16px', background: 'var(--bg-surface)', border: '1px solid var(--border-subtle)', borderRadius: 8 }}>
          <p style={{ fontSize: 11, color: 'var(--text-muted)', lineHeight: 1.6 }}>
            <strong style={{ color: 'var(--gold-primary)' }}>TradingView Integration:</strong> Live interactive NGX charts powered by TradingView will be enabled automatically when the platform is deployed to Vercel. TradingView widgets require a public domain and do not work on localhost.
          </p>
        </div>
      </PageWrapper>
    </>
